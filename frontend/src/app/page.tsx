...
export default function LandingPage() {
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-4 bg-gradient-to-tr from-[#08060f] via-[#0d0924] to-[#08060f] relative overflow-hidden">
      ...
      <div className="w-full max-w-md flex flex-col gap-6 relative z-10 animate-in fade-in slide-in-from-bottom-4 duration-300">
        ...
        <div className="flex flex-col items-center gap-2 text-center">
          <div className="w-12 h-12 rounded-xl bg-gradient-to-tr from-violet-500 to-cyan-500 flex items-center justify-center font-bold text-black text-xl shadow-lg shadow-violet-500/25">
            QG
          </div>
        ...
        <div className="glass-panel p-8 rounded-2xl flex flex-col gap-5">
          ...
          {statusMsg && (
            <div className="bg-cyan-950/30 border border-cyan-800/50 text-cyan-300 text-xs px-3 py-2 rounded-lg">
              {statusMsg}
            </div>
          )}
          ...
          {isLogin ? (
            ...
            <form onSubmit={handleLogin} className="flex flex-col gap-4">
              ...
              <button
                ...
                className="w-full py-2.5 rounded-lg text-sm font-semibold bg-violet-600 hover:bg-violet-500 text-white shadow-lg shadow-violet-500/25 transition duration-200 disabled:opacity-50 mt-2"
              >
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    className="w-full glass-input pl-10 pr-3 py-2 text-sm bg-[#120e25] text-white"
                  >
